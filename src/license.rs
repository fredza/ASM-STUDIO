...
const PUBLIC_KEY: [u8; 32] = [0xDF, 0xDA, 0xC3, 0x0E, 0x0B, 0xB2, 0xFB, 0x98, 0x8F, 0x58, 0x13, 0xE6, 0x30, 0xDD, 0x39, 0xC9, 0x27, 0x44, 0x91, 0x7C, 0x75, 0x04, 0x7C, 0xD7, 0x0C, 0x44, 0x4D, 0xF0, 0xAC, 0x6D, 0x58, 0x39];
